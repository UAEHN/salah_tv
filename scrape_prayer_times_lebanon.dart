// Lebanon Prayer Times Scraper — salatcalendar.com
//
// Switches cities using the official select_city/{id} endpoint, then fetches
// the full-year calendar via get_year.
//
// City IDs sourced from: salatcalendar.com/index.php/countries/cities/118
//
// Usage (no packages needed — pure dart:io):
//   dart scrape_prayer_times_lebanon.dart
//
// Output:
...
const String kOutputFile = 'assets/csv/lebanon_prayer_times_2026.csv';
const int kCountryId = 118;
...
//
// cityId — salatcalendar.com ID from /index.php/countries/cities/118
// ---------------------------------------------------------------------------

const List<List<String>> kLebanonCities = [
  ['Beirut',    'بيروت',    '35818'],
  ['Ras Beirut','رأس بيروت','35822'],
  ['Sidon',     'صيدا',     '35819'],
  ['Tripoli',   'طرابلس',   '35820'],
  ['Tyre',      'صور',      '35821'],
  ['Zahle',     'زحلة',     '35823'],
  ['Nabatiyeh', 'النبطية',  '35824'],
  ['Jounieh',   'جونيه',    '35825'],
  ['Habboush',  'حبّوش',    '35826'],
  ['Baalbek',   'بعلبك',    '35827'],
  ['Al Ghaziyah','الغازية', '35828'],
  ['Bsharri',   'بشري',     '35830'],
  ['Naqoura',   'الناقورة', '35831'],
  ['Jbeil',     'جبيل',     '35829'],
];
...
Future<void> main() async {
  print('====================================================');
  print('  Lebanon Prayer Times Scraper — 2026');
  ...
  for (final city in kLebanonCities) {
    final name   = city[0];
    final cityId = city[2];
    print('--- $name ---');
  ...
  print('====================================================');
  print('  Cities OK     : $ok / ${kLebanonCities.length}');
