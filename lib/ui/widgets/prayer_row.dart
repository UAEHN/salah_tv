...
class PrayerRow extends StatelessWidget {
      ...
      child: Row(
        children: [
            ...
            children: [
              Text(
                ...
                style: TextStyle(
                  ...
                  color: isNext ? palette.primary : tc.textPrimary,
                  shadows: isNext
                      ? [Shadow(color: palette.glow, blurRadius: 12)]
                      : null,
                ),
              ),
          ...
          Expanded(
            child: Text(
              ...
              style: TextStyle(
                ...
                fontWeight: isNext ? FontWeight.w600 : FontWeight.w400,
                color: isNext ? palette.primary : tc.textSecondary,
              ),
            ),
          ),
          ...
          Icon(
            ...
            size: screenH * 0.042,
            color: isNext ? palette.primary : tc.textMuted,
          ),
        ],
      ),
    );
  ...
  IconData _getIconForPrayer(String key) {
    switch (key) {
      ...
      case 'sunrise': return Icons.brightness_high_rounded;
      case 'dhuhr':   return Icons.wb_sunny_rounded;
      case 'asr':     return Icons.wb_sunny_outlined;
      case 'maghrib': return Icons.brightness_4_rounded;
