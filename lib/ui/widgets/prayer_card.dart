...
class PrayerCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final iconColor = isNext ? palette.primary : tc.textSecondary;
    final nameColor = isNext ? palette.primary : tc.textPrimary;
    final timeColor = isNext ? palette.primary : tc.textPrimary;
