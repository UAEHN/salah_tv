...
class _SplashScreenState extends State<SplashScreen>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // The splash has no interactive widgets, but its SlideTransitions build
      // RenderFractionalTranslations. A D-pad press during the reveal makes the
      // directional focus traversal measure them before first layout →
      // "RenderBox was not laid out" crash. Excluding the subtree from focus
      // removes it from traversal entirely (nothing here is focusable anyway).
      body: ExcludeFocus(
