...
class QuranNowPlayingCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final isPlaylist = settings.quranPlaybackMode == QuranPlaybackMode.playlist
        && settings.surahPlaylist.length > 1;
    ...
    return Row(
      ...
      children: [
        ...
        if (isPlaylist) ...[
          const SizedBox(width: 8),
          SurahSkipButton(palette: palette, isDarkMode: settings.isDarkMode),
        ],
      ],
    );
  }
