...
class _OnboardingScreenState extends State<OnboardingScreen>
      ...
      builder: (context, state) {
        return Scaffold(
          ...
          body: Stack(
            fit: StackFit.expand,
            children: [
              const MobileOnboardingBackground(),
              SafeArea(
                child: Column(
                  children: [
                    const SizedBox(height: 18),
                    OnboardingProgressBar(currentStep: state.step),
                    ...
                    Expanded(
                      child: AnimatedSwitcher(
                        ...
                        transitionBuilder: _slideFadeTransition(state.step),
  ...
  AnimatedSwitcherTransitionBuilder _slideFadeTransition(int currentStep) {
