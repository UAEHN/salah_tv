...
class NotificationPayloadFactory {
  ...
  void _addPrayerNotifications(
    ...
    for (final entry in day.prayersOnly) {
      ...
      if (s.prayerNotificationEnabled[entry.key] == true) {
        out.add(buildNotificationPayloadDto(
          id: NotificationIdPolicy.forPrayer(
              type: 'adhan', dayIndex: dayIndex, prayerKey: entry.key),
          type: 'adhan',
          time: adhanTime,
      ...
      if (s.preAdhanReminderEnabled[entry.key] == true) {
        out.add(buildNotificationPayloadDto(
          id: NotificationIdPolicy.forPrayer(
              type: 'pre_adhan', dayIndex: dayIndex, prayerKey: entry.key),
          type: 'pre_adhan',
          time: adhanTime.subtract(Duration(minutes: s.preAdhanReminderMinutes)),
      ...
      if (s.preIqamaReminderEnabled[entry.key] == true) {
        out.add(buildNotificationPayloadDto(
          id: NotificationIdPolicy.forPrayer(
              type: 'pre_iqama', dayIndex: dayIndex, prayerKey: entry.key),
          type: 'pre_iqama',
          time: iqamaTime.subtract(Duration(minutes: s.preIqamaReminderMinutes)),
      ...
      if (s.iqamaNotificationEnabled[entry.key] == true) {
        out.add(buildNotificationPayloadDto(
          id: NotificationIdPolicy.forPrayer(
              type: 'iqama', dayIndex: dayIndex, prayerKey: entry.key),
          type: 'iqama',
          time: iqamaTime,
  ...
  void _addAdhkarNotifications(
    ...
    if (s.isMorningAdhkarNotificationEnabled) {
      out.add(buildNotificationPayloadDto(
        id: NotificationIdPolicy.forAdhkar(
            type: 'adhkar_morning', dayIndex: dayIndex),
        type: 'adhkar_morning',
    ...
    if (s.isEveningAdhkarNotificationEnabled) {
      out.add(buildNotificationPayloadDto(
        id: NotificationIdPolicy.forAdhkar(
            type: 'adhkar_evening', dayIndex: dayIndex),
        type: 'adhkar_evening',
