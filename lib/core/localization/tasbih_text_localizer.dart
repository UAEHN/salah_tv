...
String localizedTasbihPhrase(BuildContext context, String key) {
  ...
  switch (key) {
    case 'subhanallah':
      return l.tasbihPhraseSubhanAllah;
    case 'alhamdulillah':
      return l.tasbihPhraseAlhamdulillah;
    case 'allahuakbar':
      return l.tasbihPhraseAllahuAkbar;
    case 'lailahaillallah':
      return l.tasbihPhraseLaIlahaIllallah;
    default:
      return key;
  }
}
...
String arabicTasbihPhrase(String key) => _arabic[key] ?? key;

/// Always returns the English transliteration regardless of locale.
String englishTasbihPhrase(String key) => _english[key] ?? key;
